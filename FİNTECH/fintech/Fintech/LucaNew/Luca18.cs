...
namespace Fintech.LucaNew
{
    class Luca18 : LucaN
    {
        ...
        public Luca18(DataGridView dtg, DataTable mainDataTable, OleDbConnection connection)
        {
        ...
        public DataTable AddNewColumns(DataTable mainDataTable)
        {
            ...
            mainDataTable.Columns.Add("İşlem Döviz Tutar");
            mainDataTable.Columns.Add("BOŞ");
            mainDataTable.Columns.Add("Döviz Adı");
            mainDataTable.Columns.Add("BOŞŞ");
            return mainDataTable;
        }

        public DataTable ChangeColumnNames(DataTable mainDataTable)
        {
            mainDataTable.Columns["MUAVİN DEFTER"].ColumnName = "YEVMİYE TARİHİ";
            ...
            mainDataTable.Columns["F14"].ColumnName = "İŞLEM DÖVİZ BORÇ";
            mainDataTable.Columns["F15"].ColumnName = "İŞLEM DÖVİZ ALACAK";
            mainDataTable.Columns["F16"].ColumnName = "İŞLEM DÖVİZ BAKİYE";
            mainDataTable.Columns["F18"].ColumnName = "DÖVİZ KUR";
            return mainDataTable;
        }
        ...
        public DataTable DataTableForNColumn()
        {
            ...
            //1.Sütunun adını almak için farkı bir table a sütun adları atılıyor.
            var tablename = GetTableName(connection, selectAllData);
            //-----------------------------------------------------------------
            //Table dan almak istediğimiz değerleri alıyoruz...
            var accountCode = mainDataTable.Rows[4][0].ToString();
            var accountName = mainDataTable.Rows[4][1].ToString();
            //-------------------------------------------------------------------
            //Almak istediğimiz değerler için yeni sütunlar oluşturuluyor.
            mainDataTable = AddNewColumns(mainDataTable);
            //Alınacak referans bulunuyor.
            ...
            //----------------------------
            //Gereksiz Satır ve Sütunların Silineceği For Satırları
        ...
        public DataTable DeleteUnnecessaryColumns(DataTable mainDataTable)
        {
            ...
            mainDataTable.Columns.Remove("F9");
            mainDataTable.Columns.Remove("F10");
            mainDataTable.Columns.Remove("F11");
            mainDataTable.Columns.Remove("F12");
            mainDataTable.Columns.Remove("F13");
            mainDataTable.Columns.Remove("F17");
            return mainDataTable;
        }
        ...
        public DataTable ExchangeRate(DataTable mainDataTable)
        {
            ...
            {
                var a = Convert.ToDouble(mainDataTable.Rows[i]["ALACAK"]);
                var b = Convert.ToDouble(mainDataTable.Rows[i]["İŞLEM DÖVİZ ALACAK"]);
                if (a == 0 && b == 0)
                {
                    mainDataTable.Rows[i]["DÖVİZ KUR"] = "TL";
                }
                else
                {
        ...
        public void generate()
        {
            ...
            //variables.mainDataTable.Rows[0].Delete();
            mainDataTable.AcceptChanges();
            GC.Collect();
