...
namespace Fintech.LucaNew
{
    class Luca8 : LucaN
    {
        ...
        public Luca8(DataGridView dtg,DataTable mainDataTable, OleDbConnection connection)
        {
        ...
        public void generate()
        {
           // mainDataTable = new DataTable();
            //----------------------------------------------------
            // var connection = CreateOleDbConnection();
            //connection.Open();
            //mainDataTable = ExcelToDataTable(connection, mainDataTable);
            //mainDataTable = ClassSwitcherRelatedToColumnNumber(mainDataTable, connection);
            //connection.Close();
        ...
        public DataTable AddNewColumns(DataTable mainDataTable)
        {
            ...
            mainDataTable.Columns.Add("İŞLEM DÖVİZ BORÇ");
            mainDataTable.Columns.Add("İŞLEM DÖVİZ ALACAK");
            mainDataTable.Columns.Add("İŞLEM DÖVİZ BAKİYE");
            mainDataTable.Columns.Add("İŞLEM DÖVİZ TUTAR");
            mainDataTable.Columns.Add("FİRMA DÖVİZ");
            mainDataTable.Columns.Add("DÖVİZ ADI");
            mainDataTable.Columns.Add("DÖVİZ KUR");
